...
iscounted only if it results in an AT to GC or GC to AT conversion. In
...
Compile the source code using the g++ compiler. Make sure you
have both EasyERE.cpp and 
